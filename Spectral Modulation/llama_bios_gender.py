...
class LlamaExperiment:
    ...
    def intervene(self, model, tokenizer, dataset, args):
        ...
        assert len(female_token_ids["input_ids"]) == 2 and female_token_ids["input_ids"][0] == 128000
        female_token_id = int(female_token_ids["input_ids"][1])

        male_token_ids = tokenizer("male")
        assert len(male_token_ids["input_ids"]) == 2 and male_token_ids["input_ids"][0] == 128000
...
parser.add_argument('--home_dir', type=str,
                    default="./results/bios_gender/vicuna_7b_results",
...
# Step 6: Run intervention    #Step 6: Run intervention
