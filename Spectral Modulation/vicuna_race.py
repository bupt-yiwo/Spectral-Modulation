...
import pickle
import argparse
from dataset_utils.tweet_sentiment_extraction import csv_to_lists
    ...
    def intervene(self, model, tokenizer, questions, answers , args):
        ...
        with torch.no_grad():
            ...
            for i in tqdm(range(0, dataset_size)):
                ...
                assert answer_ix in ["True", "False"]
                ...
                if answer_ix == "True":     # Answer is True
...
parser.add_argument('--home_dir', type=str,
                    default="./results/race/vicuna_7b_results",
...
questions, answers = csv_to_lists('race.csv')
