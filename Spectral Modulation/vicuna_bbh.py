...
class VicunaExperiment:
    ...
    def intervene(self, model, tokenizer, dataset, args,  choices):
    ...
    def validate(predictions, split=0.2):
        ...
        val_acc, val_logloss = VicunaExperiment.get_acc_log_loss(validation_predictions)
        test_acc, test_logloss = VicunaExperiment.get_acc_log_loss(test_predictions)
...
# def getacc(rate,rate1,rate2,rate3,rate4,rate5,fft_threshold,ifdo,model):
...
parser.add_argument('--home_dir', type=str,
                    default="./results/bbh/vicuna_7b_results",
